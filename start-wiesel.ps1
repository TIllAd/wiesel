...
Log "[1/6] Docker Desktop starten..."
...
Log "[4/6] Cloudflare Tunnel wiesel-bot starten..."
...
Log "[5/6] Cloudflare Tunnel unwritten-bot starten..."
Start-Process "cloudflared" -ArgumentList "tunnel run --url http://localhost:3000 unwritten-bot" -WindowStyle Minimized

# 6. Hermes Gateway im VS Code Terminal
Log "[6/6] Hermes Gateway in VS Code Terminal starten..."
Start-Sleep -Seconds 4
# Hermes im integrierten VS Code Terminal starten
$hermesCmd = "hermes gateway"
Start-Process "code" -ArgumentList ("--reuse-window", $ProjectDir)
Start-Sleep -Seconds 5
# VS Code CLI um Command im Terminal auszuführen
